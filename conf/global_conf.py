...
recycle_bin_path = root + '/{project}/00_UTILITY/04_PIPELINE/pipeline_recycle_bin'
"""
Template
"""
...
extensions_cache = ['abc', 'json', 'fur', 'grm']
...
doc_path = r'\\multifct\tools\pipeline\global\misc\pipeline_news.pdf'
